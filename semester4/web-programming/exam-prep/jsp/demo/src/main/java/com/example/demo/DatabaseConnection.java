...
public class DatabaseConnection {
    ...
    private static final String DB_URL = "jdbc:mysql://localhost:3306/DocumentsAndStuff";
    ...
    static {
        try {
            ...
            try {
                ...
                System.err.println("MySQL Driver not found! Make sure mysql-connector-j is in your dependencies.");
                throw new RuntimeException("MySQL Driver not found", e2);
            }
        }
    }
