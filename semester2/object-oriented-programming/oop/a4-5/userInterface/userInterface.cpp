...
void UserInterface::getFile() {
    ...
    cin >> option;
    if(option == 1) {
        this->controller = new Controller(R"(C:\Users\lucac\CLionProjects\oop-a4-5-kpunkk_6-7\src\movies.csv)", "CSV");
    } else {
        this->controller = new Controller(R"(C:\Users\lucac\CLionProjects\oop-a4-5-kpunkk_6-7\src\movies.html)", "HTML");
    }
}
