...
void Controller::addController(Movie *movie) {
...
void Controller::removeByName(const string& name) {
...
void Controller::generateMovies() {
    ...
    auto *movie2 = new Movie("Come-and-See", "History", "https://youtu.be/UHaSQU-4wss?si=MEeaZosrbh8B1GMx", 1985, rand() % 100 + 1, false);
    auto *movie3 = new Movie("12-Angry-Men", "Drama", "https://youtu.be/TEN-2uTi2c0?si=V5axgNwsrRDl3xX6", 1957, rand() % 100 + 1, false);
    auto *movie4 = new Movie("Seven-Samurai", "Action", "https://youtu.be/wJ1TOratCTo?si=_zs5RithlkNdCRvR", 1954, rand() % 100 + 1, false);
    auto *movie5 = new Movie("The-Godfather:-Part-II", "Crime", "https://youtu.be/9O1Iy9od7-A?si=P7DMkZb9ETwIVP78", 1974, rand() % 100 + 1, false);
    auto *movie6 = new Movie("High-and-Low", "Crime", "https://youtu.be/LV3z2Ytxu90?si=YcZEU6cJSFJQWJQF", 1963, rand() % 100 + 1, false);
    auto *movie7 = new Movie("Parasite", "Drama", "https://youtu.be/5xH0HfJHsaY?si=7jIVe7Hfk6htsnU3", 2019, rand() % 100 + 1, false);
    auto *movie8 = new Movie("The-Godfather", "Crime", "https://youtu.be/UaVTIH8mujA?si=U9640-BFD74SW5o8", 1972, rand() % 100 + 1, false);
    ...
    auto *movie12 = new Movie("Dune:-Part-Two", "Sci-Fi", "https://youtu.be/U2Qp5pL3ovA?si=2u3w6-lUpAdK43If", 2024, rand() % 100 + 1, false);
    ...
    auto *movie15 = new Movie("Ikiru", "Drama", "https://youtu.be/2VeLN3IDjzQ?si=jE1uJgtbPV82KxLC", 1952, rand() % 100 + 1, false);
